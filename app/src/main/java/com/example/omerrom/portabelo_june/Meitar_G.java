 ...
 */
public class Meitar_G extends AppCompatActivity implements Meitar {
    float phone_velocity_X;
    float phone_velocity_Y;
    float phone_position_X;
    float phone_position_Y;

    public Meitar_G(float phone_velocity_X, float phone_velocity_Y, float phone_position_X, float phone_position_Y) {
