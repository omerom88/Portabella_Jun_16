 ...
 */
public class Meitar_E_HIGH extends AppCompatActivity implements Meitar {
    float phone_velocity_X;
    float phone_velocity_Y;
    float phone_position_X;
    float phone_position_Y;

    public Meitar_E_HIGH(float phone_velocity_X, float phone_velocity_Y, float phone_position_X, float phone_position_Y) {
