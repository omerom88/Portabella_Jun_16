 ...
 */
public class Meitar_B extends AppCompatActivity implements Meitar {
    float phone_velocity_X;
    float phone_velocity_Y;
    float phone_position_X;
    float phone_position_Y;

    public Meitar_B(float phone_velocity_X, float phone_velocity_Y, float phone_position_X, float phone_position_Y) {
